                ...
                <div class="main-wrap">
                            ...
                            ">
                                ...
                                <div class="new-mu_l2a new-p-re">
                                    <p class="new-mu_l2cw">
                                        ...
                                        <span class="province">{{$v['address'].$v['detailed']}}</span>

                                </div>
                                <div class="new-addr-btn">
                                    <a href="/center/UpdateAddress/{{ $v['id'] }}"><i class="am-icon-edit"></i>编辑</a>
                                    <span class="new-addr-bar">|</span>
                                    <a href="javascript:;" onClick="delClick({{$v['id']}},this);"><i class="am-icon-trash"></i>删除</a>
                                </div>
                            </li>
                            @empty
                                <span style="margin-left:69px;">暂无地址</span>
                            @endforelse
                        ...
                        <div class="am-modal am-modal-no-btn" id="doc-modal-1">
                            ...
                            <div class="add-dress">
                                ...
                                <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                                    <form class="am-form am-form-horizontal" action="/center/ImplementAddres" method="post">
                                         {{ csrf_field() }}
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-content">
                                                <input id="user-phone" name="atel" placeholder="手机号必填" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-content">
                                                <textarea style="resize:none;width: 571px;height: 73px;" class="" rows="3" id="user-intro" name="address" placeholder="输入详细地址"></textarea>
                    ...
                    <script>
                         ...
                         function defaultAddr(id){
                            let url = '/center/DefaultAddress/'+id;
                         ...
                         function ashjgdj(){
                            ...
                            // 删除收货地址
                            function delClick(id,obj){

                                let url = '/center/DeleteAddress/'+id;
                                layer.msg('你确定要删除吗?', {
                                  time: 0 //不自动关闭
                                  ,btn: ['确定', '再考虑']
                                  ,yes: function(index){
