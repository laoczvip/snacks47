                                                    ...
                                                    <li class="td td-item">
                                                        ...
                                                        <div class="item-info">
                                                            <div class="item-basic-info">
                                                                <a href="/home/personal/introduction?ids={{$goods_sku->gid}}" class="item-title J_MakePoint" data-point="tbcart.8.11">{{  $goods_sku->title}}</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="td td-info">
            ...
            <!-- 新增地址 弹框 开始 -->
                ...
                <div class="am-cf am-padding">
                    ...
                    <div class="am-u-md-12">
                        <form class="am-form am-form-horizontal" action="/addres" method="post">
                            {{ csrf_field() }}
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-content">
                                                <textarea style="resize:none;width: 385px;height: 73px;" class="" rows="3" id="user-intro" name="address" placeholder="输入详细地址"></textarea>
...
<script>
        ...
        var price = $('#pprasdsaice').text();
        $('#pprice').val(price);

        // 添加收货地址
        function ashjgdj(){
                var phome = $('#user-phone').val();
        ...
        function numAdd(){
            ...
            if(num_add>=stock){
                ...
                var a =  document.getElementById("totalPrice").innerHTML=Num.toFixed(2);
                $('#pprice').val(a);
                $('#pprasdsaice').text(a);
                $('#number').val(quantity);
