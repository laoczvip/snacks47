                ...
                <div class="paycont">
                    ...
                    <div class="concent">
                        <div id="payTable">
                            ...
                            @foreach($data as $k=>$v)
                            <div class="clear"></div>
                        <form action="/adddatabase" method="post" accept-charset="utf-8">
                            <tr class="item-list">
                                     ...
                                     {{ csrf_field() }}
                                        <div class="bundle-main">
                                            <ul class="item-content clearfix">
                                                <div class="pay-phone">
                                                    <li class="td td-item">
                                                        <div class="item-pic">
                                                            <a href="#" class="J_MakePoint">
                                                                <img src="/uploads/{{ $v->showcase }}" class="itempic J_ItemImg" width="100"></a>
                                                        </div>
                                                        <div class="item-info">
                                                    ...
                                                    <li class="td td-info">
                                                        ...
                                                        <div class="item-props">
                                                            <span class="sku-line">口味：{{ $v->flavor }}</span>
                                                ...
                                                <li class="td td-sum">
                                                    <div class="td-inner">
                                                        <em tabindex="0" class="J_ItemSum number" id="totalPrice">{{ $v->xiaoji }}</em>
                                                    </div>
                                                </li>
                        ...
                        <!--留言-->
                            ...
                            <div class="buy-point-discharge ">
                                <p class="price g_price ">
                                    合计（含运费） <span>¥</span><em class="pay-sum" id="pprasdsaice">{{$pricecount}}</em>
                                </p>
                            </div>
