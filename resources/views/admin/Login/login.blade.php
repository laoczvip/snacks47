      ...
      <dl class="admin_login">
           <form action="/admin/dologin" method="post">
              {{ csrf_field() }}
                 ...
                 <dd class="pwd_icon">
                    <input type="text"  id="code" style="width:143px;" placeholder="验证码" class="login_txtbx" autocomplete="off"/>
...
//一般直接写在一个js文件中
    ...
    <script>
        function login(){
            ...
            let code = $('#code').val();
             $.get('/admin/dologin',{number,password,code},function(res){
                if (res == 1) {
