        ...
        <form action="/admin/goods/update" method="post" enctype="multipart/form-data">
            ...
            <ul class="ulColumn2">
                ...
                <li>
                    ...
                    <input type="text" name="original" class="textbox textbox_225" value="{{$goods_sku->original}}" placeholder="请输入4~16位字母或者数字"/>
                    <!-- <span class="errorTips">错误提示信息...</span> -->
                </li>
                <li>
                   ...
                   <li>
                    <span class="item_name" style="width:120px;">商品参数:</span>
                         ...
                         <div style="width:800px; 
                                    ...
                                    -webkit-line-clamp: 3;
                                    overflow: hidden;">
                        <script id="content" name="parameter" type="text/plain">{!!$goods_sku->parameter!!}</script>
                        </div>
